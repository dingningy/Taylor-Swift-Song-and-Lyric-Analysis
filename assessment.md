...
Mini-project title: Taylor Swift: Song and Lyric Analysis

Submission date: 2025/02/17

Project GitHub subdirectory URL: https://github.com/dingningy/Taylor-Swift-Song-and-Lyric-Analysis.git
...
2. Did you use LLMs or other AI models to generate text or code for this project? If so, which tools did you use and how did you use them? Remember in this class you *are* allowed (even encouraged) to use these tools for help with coding, but not for writing text. This can be very brief, just one or two sentences is fine unless you have more you'd like to add.
    1. answer here 
- I used Poe AI for troubleshooting when I could not fix the error by Google. 
3. For off-the-menu projects only, did you complete the project as proposed? If not, what changed?
    1. answer here or n/a
- I do! I'm so proud of this project. It's much more exciting than I thought.
...
1. I use frequent, informative comments in code and markdown as you can see in my assignment. I have added comments to explain the purpose of each code chunk, the function of each line of code, and the necessary details of the data cleaning process.
2. I find and understand documentation for R packages and functions from Google, such as tidytext and textdata in this project.
3. I follow a debugging workflow with independent and collaborative strategies, and even supernatural power (jk). I have used the console to troubleshoot errors and have asked for help from Google or Poe AI. I asked my friends and sometimes my dad (for troubleshooting ngl since he is better at asking LLMs using appropriate prompts than me). I also put my rubber ducks and mini figures from pop mart aside me to manifest coding power.
4. I parse and investigate error messages. I have read error messages to understand what went wrong and have used this information to fix my code. For instance, when specific functions could not be run, I doubled check if I have installed/updated the packages for that specific function.

RStudio & R (1 objective)

9. I create and use intermediate datasets. I have created intermediate datasets in my project to store the cleaned data and the data that I have transformed. I have used the intermediate dataset to create visualizations and perform analyses.
...
1. I have used plotly to do interactive data visualization in the html output.

2. I have conducted sentiment analysis on the lyrics of Taylor Swift's songs using the tidytext package, and use KableExtra and multiple visualizations to display the results.

3. I have used wordcloud to visualize the most frequent words in the lyrics of Taylor Swift's songs.
...
I have to say I gained a lot during the process since I finally managed to conduct sentiment analysis using R (yay)! I also incorporated different files in the HTML output using the quarto document, including audio, video, PDF, etc. Also employed Kable to make beautiful tables based on color palettes for different albums of Tay. I'm so proud of this project and I had so much fun coding my favorite stuff in this class!
